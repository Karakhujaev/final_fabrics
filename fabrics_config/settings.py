"""
Django settings for fabrics_config project.
...
SECRET_KEY = 'django-insecure-menl&_zg=ul!4k1g7e_2k!oy*ni2k6pe$k1k*3*+k&_vxm@^58'
...
LOGIN_REDIRECT_URL = 'user_account:login'
...
ROOT_URLCONF = 'fabrics_config.urls'
...
WSGI_APPLICATION = 'fabrics_config.wsgi.application'
...
CKEDITOR_CONFIGS = {
    'default': {
        ...
        'toolbar': 'Custom', 'full'  # put selected toolbar config here
...
JAZZMIN_SETTINGS = {
    ...
    # "site_title": "Sofdilshop.uz",

    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    # "site_header": "Sofdilshop.uz",

    # Title on the brand (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_brand": "Sofdilshop.uz",
